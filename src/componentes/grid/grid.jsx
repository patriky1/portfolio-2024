        ...
        <Carousel.Item interval={null}>
          ...
          <div className="sobremim">
            <h5 className="sobremim">
              ...
              Meu objetivo é entregar experiências memoráveis para novas marcas
              e para aqueles que desejam digitalizar-se. Trabalho como
              programador desde 2019, e me considero um profissional autodidata
              com visão estratégica, grande adaptabilidade e bom fortalecimento
              de equipes. Me graduei na Área de Redes de Computadores (UNIP).
              Atualmente trabalhando como desenvolvedor front-end na Lane art
              design e Formador de profissionais ágeis que buscam adentar no
              mercado da programação. <br></br>No meu tempo livre, gosto de
              experimentar cachaças artesanais, cozinhar novos pratos, viajar e
  ...
  return (
    <Carousel>
      <Carousel.Item interval={500}>
        <img className="d-block w-100" src={projects} alt="Second slide" />
        <Carousel.Caption>
